...
// Returns 1 if X wins, -1 if 0 wins, 0 otherwise
...
function testFindBestMove() {
    ...
    for (var i = 0; i < testCases.length; i++) {
        ...
        assertEqual(result.pos, testCase.expect.pos, `${i+1}. Correct position.`);
...
function assertEqual(val, expected, name) {
    ...
    //Converts values to JSON format and compare that to handle
    //arrays and objects better.
